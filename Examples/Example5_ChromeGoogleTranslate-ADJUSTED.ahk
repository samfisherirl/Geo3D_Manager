...
cUIA.Navigate("https://spinbot.com/") ; Set the URL and navigate to it
cUIA.WaitPageLoad() ; Wait the page to load
EnglishEl := cUIA.FindFirstByName("Your text to rewrite...") 
EnglishEl.Click()
Sleep, 500
jake := Clipboard
SendRaw, %jake%
...
EnglishEl.Click()
sleep, 500  
cUIA.FindFirstByName("Paraphrase").Click(500)
sleep, 2000
msgbox % cUIA.GetCurrentPropertyValue("editable-content-within-article~0~0~0") 
