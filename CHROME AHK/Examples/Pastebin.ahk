...
ChromeProfile := A_ScriptDir "\ChromeProfile"
...
else
{
	...
	PageInst.Call("Page.navigate", {"url": "https://www.eporner.com/video-3jafOxZkK9g/i-fucked-my-roommate-sorry-to-her-boyfriend/"})
	...
	; Find the root node
		sleep, 1000
	john := PageInst.Evaluate("document.getElementById('download').getAttribute('href');")
